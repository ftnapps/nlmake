...
int main (short ParmsCtr, char *Parms[])
{
  ...
  printf("This version retains orginal copyrights with modifications\nreleased under the GPL\n");
  ...
  for(cntr2=1; cntr2<=(ParmsCtr-1); cntr2++)
  {
                ...
                {
                        if(strnicmp(Parms[cntr2],LinePrms[cntr].Single,strlen(LinePrms[cntr].Single)) == 0)
                     break;
...
int proctrlfile(void)
{
  ...
  if(ControlFile[0] == 0) return errorlvl;

        outfilep = fopen ("data.tmp", "wt+");
        if(outfilep == NULL)
        {
         if(errno <= 39)
         sprintf(LogLine,"Critial Error - Can not open temporary file <%s>",errnostr[errno]);
         else
  ...
  ctrlfile = fopen (ControlFile, "rt+");
        ...
        {
         if(errno <= 39)
         sprintf(LogLine,"Critial Error - Can not open file %s <%s>",ControlFile,errnostr[errno]);
         else
...
//                      *(ptr+strlen(str)) = 0;
        if(str[0] != 0 && strlen(str) >= 4)
        {
                ...
                {
                         if(strnicmp(str,CfilePrms[cntr].Single,strlen(CfilePrms[cntr].Single)) == 0)
                         {
                          break;
                         }
                          else
                ...
                if(CfilePrms[cntr].Type == 99)
                        {
                        if(mark_data == 1) cntr = 27;
                        else if(mark_file == 1) cntr = 28;
                        } else {
                                         mark_data = 0;
                                         mark_file = 0;
                                         }
                ...
                memmove(ptr,ptr+1,(strlen(ptr)-1));
                                ...
                                {
                                if(strnicmp(ptr,SegmentType[cnt].Single,strlen(SegmentType[cnt].Single)) == 0)
                                        {
                ...
                memmove(ptr2,ptr2+1,(strlen(ptr)-1));
                                ...
                                logwrite(CF_MAKE,0);
                                sprintf(LogLine,"%s [%d] [%s]",SegmentType[MAKETYPE].String,MAKENUMBER,expSourceFile);
                ...
                memmove(ptr,ptr+1,(strlen(ptr)-1));
                                ...
                                {
                                if(strnicmp(ptr,WeekDays[cnt].Single,strlen(WeekDays[cnt].Single)) == 0)
                                        {
                                        strncpy(Publish_day,WeekDays[cnt].String,strlen(WeekDays[cnt].String));
                                        break;
                                        }
                                cnt++;
                                }
                ...
                memmove(ptr,ptr+1,(strlen(ptr)-1));
                                ...
                                if(strnicmp(ptr,WeekDays[cnt].Single,strlen(WeekDays[cnt].Single)) == 0)
                                        {
                                        strncpy(Process_day,WeekDays[cnt].String,strlen(WeekDays[cnt].String));
                                        break;
                                        }
                                cnt++;
                                }
                ...
                memmove(ptr,ptr+1,(strlen(ptr)-1));
                                ...
                                {
                                if(strnicmp(ptr,PVTDisposition[cnt].Single,strlen(PVTDisposition[cnt].Single)) == 0)
                                        {
                        ...
                        logwrite(CFE_ABORT,0);
                                ...
                                if(ptr == NULL || ptr2 == NULL)
                                  segfile[0].NameNotify[0] = 0;
                                        ...
                                        {
                                        if((ptr2 - ptr) <= 72)
                                        strncpy(segfile[0].NameNotify,ptr+1,(ptr2 - ptr - 1));
                                        else
                ...
                memmove(ptr,ptr+1,(strlen(ptr)-1));
                        ...
                        logwrite(CFE_ABORT,0);
                                ...
                                {
                                if(strstr(strupr(ptr),MFlagstype[cnt].String) != NULL)
                                {
                ...
                memmove(ptr,ptr+1,(strlen(ptr)-1));
                        ...
                        case 28:             // Data
                                ...
                                {
                                        logtext("Master input file and DATA stream both specified",0,YES);
                           logwrite(CFE_ABORT,0);
                                logwrite(SYS_STOP,0);
                                closelog(); // close logfile
                                        exit(255);
                        ...
                        logwrite(CFE_ABORT,0);
                                ...
                                while(SegmentType[cnt].Single != NULL)
                                {
                                        if(strnicmp(str,SegmentType[cnt].Single,strlen(SegmentType[cnt].Single)) == 0)
                                        {
                                                segfile[sfilecnt].SegmentType = SegmentType[cnt].Type;
                                                break;
                                        }  else
                                        cnt++;
                                }
                ...
                memmove(ptr,ptr+1,(strlen(ptr)-1));
                                ...
                                if(MAKETYPE <= segfile[sfilecnt].SegmentType)
                                        {
                                        logwrite(CFE_FILES_STYPE,linecnt);
                                        sprintf(LogLine,"A %s segment can not contain a %s segment",
                                                                                        SegmentType[MAKETYPE].String,
                                                                                        SegmentType[segfile[sfilecnt].SegmentType].String);
                                        logtext(LogLine,0,YES);
                                        logwrite(CFE_ABORT,0);
                                logwrite(SYS_STOP,0);
                                closelog(); // close logfile
                 ...
                 ptr2 = strtok(altnot," \r\n"); // 1
                                ...
                                if(ptr == NULL || ptr2 == NULL)
                                  segfile[sfilecnt].NameNotify[0] = 0;
                                        ...
                                        {
                                        if((ptr2 - ptr) <= 72)
                                        strncpy(segfile[sfilecnt].NameNotify,ptr+1,(ptr2 - ptr - 1));
                                        else
                                        strncpy(segfile[sfilecnt].NameNotify,ptr+1,72);
                                        }
                ...
                memmove(ptr,ptr+1,(strlen(ptr)-1));
                                ...
                                while(compressor_name[cnt] != 0)
                                                {
                                                        if(strnicmp(ptr,compressor_name[cnt],strlen(compressor_name[cnt])) == 0)
                                                        {
                                                         DefCompressor = cnt;
                                                         sprintf(LogLine,"Outbound compressor set to %s",compressor_name[cnt]);
                                           ...
                                           if(compressor_name[cnt] == 0)
                                                {
                                                 DefCompressor = 0;
                                                 sprintf(LogLine,"Outbound compressor default %s",compressor_name[0]);
                                                 logtext(LogLine,2,YES);
                                                }
                                cntr = 0;
                                break;
...
void testctrlinfo(void)
{
        ...
        // test baudrates set defaults
                if(BaudRates[0] == 0)
                {
                logtext("No BaudRates statement - Def 300,1200,2400,4800,9600",4,YES);
        ...
        logwrite(CFE_ABORT,0);
                ...
                exit(255);
                ...
                else
                        {
                                ...
                                {
                                jfriday = getJDate(1);
                                sprintf(OutFile,"%s%s.%0.3d",OutPath,buffer,jfriday);
                                if(CLEANUP == 'Y') CLEANUPOUT = 'Y';
                                } else
                                         {
                                        ...
                                        logwrite(CFE_THRESHOLD,0);
                                                logtext("Can not create Diff - Outfile has an Explicit extension",0,YES);
                                        logwrite(CFE_ABORT,0);
                                logwrite(SYS_STOP,0);
                                closelog(); // close logfile
                                                exit(255);
        ...
        // test outdiff
                ...
                logtext("No OutDiff statement - Diff not produced",4,YES);
                else
                        {
                                ...
                                {
                                jfriday = getJDate(1);
                                sprintf(OutDiff,"%s%s.%0.3d",OutPath,buffer,jfriday);
                                } else
                                        {
        ...
        // test comments
          ...
          if(PVTlvl == 0)
                {
                logtext("Default - Private nodes are restricted to NETWORK/HUB level.",5,YES);
                PVTlvl = 3;
                } else
                                {
                                        switch(PVTlvl)
                                        {
                                                case 0:
                                                PVTlvl = 3;
                                                logtext("Private nodes are restricted to NETWORK/HUB level.",5,YES);
                                                break;
                                                case 1:
                                                ...
                                                break;
                                                case 4:
                                                logtext("Private nodes are restricted to REGION/NETWORK/HUB level.",5,YES);
                                                break;
                                                case 5:
...
void printctrlinfo(void)
{
    ...
    printf("Control File    : %s\n",ControlFile);
         printf("Make            : %s [%d] [%s]\n",SegmentType[MAKETYPE].String,MAKENUMBER,expSourceFile);
         printf("Process         : %s\n",Process_day);
         printf("Publish         : %s\n",Publish_day);
    ...
    printf("OutFile         : %s\n",OutFile);
    printf("OutPath         : %s\n",OutPath);
         printf("Threshold       : %ld %ld\n",threshold.arc_size,threshold.diff_size);
    printf("Arc             : %d\n",ARC);
    printf("OutDiff         : %s\n",OutDiff);
         printf("Cleanup         : %c\n",CLEANUP);
    printf("NetAddress      : %s\n",NetAddress);
    ...
    printf("Submit          : %s ",SubAddress);
         if(mnotify[3].Crash == 'Y') printf("Crash,");
         if(mnotify[3].Hold == 'Y') printf("Hold,");
         if(mnotify[0].Intl == 'Y') printf("Intl,");
         if(mnotify[3].Normal == 'Y') printf("Normal,");
    printf("\n");
         ...
         {
         printf("Receipt- ");
         if(mnotify[0].Crash == 'Y') printf("Crash,");
         if(mnotify[0].Hold == 'Y') printf("Hold,");
         if(mnotify[0].Intl == 'Y') printf("Intl,");
         if(mnotify[0].Normal == 'Y') printf("Normal,");
         }

         if(mnotify[1].active == 'Y')
         {
         printf("Errors- ");
         if(mnotify[1].Crash == 'Y') printf("Crash,");
         if(mnotify[1].Hold == 'Y') printf("Hold,");
         if(mnotify[1].Intl == 'Y') printf("Intl,");
         if(mnotify[1].Normal == 'Y') printf("Normal,");
         }

         if(mnotify[2].active == 'Y')
         {
         printf("Self- ");
         if(mnotify[2].Crash == 'Y') printf("Crash,");
         if(mnotify[2].Hold == 'Y') printf("Hold,");
         if(mnotify[2].Intl == 'Y') printf("Intl,");
         if(mnotify[2].Normal == 'Y') printf("Normal,");
         }
    printf("\n");
...
short is_proc_day(short file_day)
{
  ...
  if(date.dayofweek == file_day) return(0);
  else return(1);
